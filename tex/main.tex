...
Dynamic programming is closely related, but it is usually presented as a \emph{bottom-up} approach. Instead of starting with recursion, we systematically fill in a table of solutions to smaller subproblems and build up to the final answer. Both methods rely on solving overlapping subproblems and reusing previously computed results, but memoization stores results during recursion, while dynamic programming typically computes them iteratively in a table.
